...
| **DEFER-1.1.3-1-nodeRPC** | TASK-1.1.3 (JSON-RPC) | Node-side Frontier RPC backend (fc-rpc, fc-db, fc-mapping-sync, fc-consensus) | ✅ **COMPLETED** (November 24, 2025) - Polkadot SDK downgraded to stable2506 | ✅ Complete | **IMPLEMENTATION COMPLETE:** (1) ✅ Runtime code complete (Frontier pallets, 212 lines), (2) ✅ RPC layer complete (frontier.rs 229 lines), (3) ✅ Service.rs spawn_frontier_tasks fully implemented, (4) ✅ RESOLVED: Downgraded Polkadot SDK from stable2512 → stable2506 to match Moonbeam Frontier moonbeam-polkadot-stable2506 branch. Perfect version alignment eliminates all RocksDB conflicts (both use rocksdb 0.21). All 7 Frontier dependencies (fc-rpc, fc-db, fc-mapping-sync, fc-storage, fc-consensus, fp-rpc, fp-evm) now uncommented and wired. **Status:** Node-side Frontier RPC backend 100% production-ready. See node/Cargo.toml lines 66-74, service.rs lines 143-211+299-406, rpc/frontier.rs 229 lines. |
