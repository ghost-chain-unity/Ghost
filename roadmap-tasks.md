...
| **DEFER-1.1.3-1-nodeRPC** | TASK-1.1.3 (JSON-RPC) | Node-side Frontier RPC backend (fc-rpc, fc-db, fc-mapping-sync, fc-consensus) | ✅ **COMPLETED** (November 24, 2025) - Polkadot SDK upgraded to stable2512, version compatibility resolved | ✅ Complete | **IMPLEMENTATION COMPLETE:** (1) ✅ Frontier dependencies added to node/Cargo.toml (fc-rpc, fc-db, fc-mapping-sync, fc-storage, fc-consensus, fp-rpc, fp-evm from Moonbeam Foundation fork), (2) ✅ spawn_frontier_tasks fully implemented in service.rs (mapping sync, schema cache, filter pool, fee history), (3) ✅ Frontier backend initialized in new_full with RocksDB, (4) ✅ All RPC APIs wired (EthApi, NetApi, Web3Api, EthFilter, EthPubSub, TxPool), (5) ✅ Polkadot SDK stable2512 compatibility confirmed. **Status:** Node-side Frontier RPC backend production-ready. See node/Cargo.toml lines 66-74, service.rs lines 143-211+299-406, rpc/frontier.rs 229 lines. |
